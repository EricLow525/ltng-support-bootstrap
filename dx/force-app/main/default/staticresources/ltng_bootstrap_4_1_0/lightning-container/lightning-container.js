...
window.sendMessage = function(userMessage) {
...
window.addErrorHandler = function(handler) {
    if (typeof LCC !== "undefined" && typeof LCC.onlineSupport !== "undefined") {
...
window.removeErrorHandler = function(handler) {
    if (typeof LCC !== "undefined" && typeof LCC.onlineSupport !== "undefined") {
...
window.addMessageHandler = function(handler) {
    if (typeof LCC !== "undefined" && typeof LCC.onlineSupport !== "undefined") {
...
window.removeMessageHandler = function(handler) {
    if (typeof LCC !== "undefined" && typeof LCC.onlineSupport !== "undefined") {
...
window.getRESTAPISessionKey = function() {
    if (typeof LCC !== "undefined" && typeof LCC.onlineSupport !== "undefined") {
...
window.callApex = function(fullyQualifiedApexMethodName,
